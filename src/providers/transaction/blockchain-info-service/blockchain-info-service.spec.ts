...
describe('Transaction Service', () => {
    ...
    it('should build correct urls', () => {
        expect(transactionService.buildUrl({
            ...
            to : 15 ,
            from : 5
        })).toEqual('https://blockchain.info/multiaddr?active=152f1muMCNa7goXYhYAQC61hxEgGacmncB|12ni9ddt4WHfEQriVN7DajDBd1JbKL9yUZ|1FS4FF2SYdHf3PGfSbjpdYcUiUYxiVLy73&limit=10&offset=5&cors=true');
    });
